...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'massage-spa-pro' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'massage-spa-pro' ),
		'repeat-y'  => __( 'Repeat Vertically', 'massage-spa-pro' ),
		'repeat'    => __( 'Repeat All', 'massage-spa-pro' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'massage-spa-pro' ),
		'top center'    => __( 'Top Center', 'massage-spa-pro' ),
		'top right'     => __( 'Top Right', 'massage-spa-pro' ),
		'center left'   => __( 'Middle Left', 'massage-spa-pro' ),
		'center center' => __( 'Middle Center', 'massage-spa-pro' ),
		'center right'  => __( 'Middle Right', 'massage-spa-pro' ),
		'bottom left'   => __( 'Bottom Left', 'massage-spa-pro' ),
		'bottom center' => __( 'Bottom Center', 'massage-spa-pro' ),
		'bottom right'  => __( 'Bottom Right', 'massage-spa-pro')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'massage-spa-pro' ),
		'fixed'  => __( 'Fixed in Place', 'massage-spa-pro')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'massage-spa-pro' ),
		'italic'      => __( 'Italic', 'massage-spa-pro' ),
		'bold'        => __( 'Bold', 'massage-spa-pro' ),
		'bold italic' => __( 'Bold Italic', 'massage-spa-pro' )
		);
