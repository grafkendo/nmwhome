...
if ( ! class_exists( 'VW_Yoga_Fitness_Content_Creation' ) ) :

	/**
	 * VW_Yoga_Fitness_Content_Creation class.
	 */
	class VW_Yoga_Fitness_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_Yoga_Fitness_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Yoga_Fitness_Content_Creation' );
