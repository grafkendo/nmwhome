...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'yoga-club' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'yoga-club' ),
		'repeat-y'  => __( 'Repeat Vertically', 'yoga-club' ),
		'repeat'    => __( 'Repeat All', 'yoga-club' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'yoga-club' ),
		'top center'    => __( 'Top Center', 'yoga-club' ),
		'top right'     => __( 'Top Right', 'yoga-club' ),
		'center left'   => __( 'Middle Left', 'yoga-club' ),
		'center center' => __( 'Middle Center', 'yoga-club' ),
		'center right'  => __( 'Middle Right', 'yoga-club' ),
		'bottom left'   => __( 'Bottom Left', 'yoga-club' ),
		'bottom center' => __( 'Bottom Center', 'yoga-club' ),
		'bottom right'  => __( 'Bottom Right', 'yoga-club')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'yoga-club' ),
		'fixed'  => __( 'Fixed in Place', 'yoga-club')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'yoga-club' ),
		'italic'      => __( 'Italic', 'yoga-club' ),
		'bold'        => __( 'Bold', 'yoga-club' ),
		'bold italic' => __( 'Bold Italic', 'yoga-club' )
		);
