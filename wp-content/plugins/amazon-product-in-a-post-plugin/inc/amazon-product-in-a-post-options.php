	...
	function appip_start_options(){
		...
		$options_apipp= array (
			...
			array(	"name" => __('Your Amazon Locale/Region','amazon-product-in-a-post-plugin'),
					"desc" => __('The Locale to use for Amazon API Calls (ca, cn, com, com.au, com.br, co.uk, de, fr, jp, es, in, it). Default is "com" for US.','amazon-product-in-a-post-plugin')."<br /><br />",
			...
			array(	"name" => __('Amazon Access Key ID','amazon-product-in-a-post-plugin'),
					...
					<a target='_blank' href='https://associados.amazon.com.br/gp/associates/apply/main.html'>".__('Brazil', 'amazon-product-in-a-post-plugin')." (com.br)</a>, 
					<a target='_blank' href='https://associates.amazon.ca/gp/advertising/api/detail/main.html'>".__('Canada', 'amazon-product-in-a-post-plugin')." (ca)</a>, 
					<a target='_blank' href='https://associates.amazon.cn/gp/advertising/api/detail/main.html'>".__('China', 'amazon-product-in-a-post-plugin')." (cn)</a>, 
					<a target='_blank' href='https://partenaires.amazon.fr/gp/advertising/api/detail/main.html'>".__('France', 'amazon-product-in-a-post-plugin')." (fr)</a>, 
					<a target='_blank' href='https://affiliate-program.amazon.de/gp/advertising/api/detail/main.html'>".__('Germany', 'amazon-product-in-a-post-plugin')." (de)</a>, 
					<a target='_blank' href='https://affiliate-program.amazon.in/gp/advertising/api/detail/main.html'>".__('India', 'amazon-product-in-a-post-plugin')." (in)</a>, 
					<a target='_blank' href='https://programma-affiliazione.amazon.it/gp/advertising/api/detail/main.html'>".__('Italy', 'amazon-product-in-a-post-plugin')." (it)</a>, 
					<a target='_blank' href='https://affiliate.amazon.co.jp/gp/advertising/api/detail/agreement.html'>".__('Japan', 'amazon-product-in-a-post-plugin')." (jp)</a>, 
					<a target='_blank' href='https://afiliados.amazon.com.mx/gp/advertising/api/detail/main.html'>".__('Mexico', 'amazon-product-in-a-post-plugin')." (com.mx)</a>, 
					<a target='_blank' href='https://afiliados.amazon.es/gp/advertising/api/detail/main.html'>".__('Spain', 'amazon-product-in-a-post-plugin')." (es)</a>, 
					<a target='_blank' href='https://affiliate-program.amazon.co.uk/gp/flex/advertising/api/sign-in.html'>".__('United Kingdom', 'amazon-product-in-a-post-plugin')." (co.uk)</a>, 
					<a target='_blank' href='https://affiliate-program.amazon.com/gp/flex/advertising/api/sign-in.html'>".__('United States', 'amazon-product-in-a-post-plugin')." (com)</a>
					<br>".__('For general information, visit the','amazon-product-in-a-post-plugin')." <a target='_blank' href='https://docs.aws.amazon.com/AWSECommerceService/latest/DG/localevalues.html'>'".__('Locale Reference for the Product Advertising API','amazon-product-in-a-post-plugin')."</a> ".__('page.','amazon-product-in-a-post-plugin'),
